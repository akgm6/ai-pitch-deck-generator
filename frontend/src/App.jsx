...
// Add helpers for new endpoints
async function regenerateSlideApi(slide, feedback) {
...
async function generateSpeakerNotesApi(title, content) {
...
export { regenerateSlideApi, generateSpeakerNotesApi };
